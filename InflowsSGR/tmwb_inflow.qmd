...
Questions: 
myflowgage$area ~line 100. Should this be the watershed area or the lake area? I took the lake area for Sunapee.
I need arrow. Can I use arrow in Docker? I'm on an M3 chip now.
- I need to install the arm64 version of R on this mac!!!
...
#For Sunapee
# myflowgage$area<- 16.9342516 #km2, taken from the Sunapee Lake Area. This is not SUNP watershed area
